...
N 650 -320 700 -320 { lab=Cap1}
N 760 -220 900 -220 { lab=Cap2}
N 800 -380 900 -380 { lab=Cap3}
N 840 -280 900 -280 { lab=Cap2}
N 900 -380 920 -380 { lab=Cap3}
...
C {devices/iopin.sym} 700 -320 0 0 {name=p3 lab=Cap1}
C {devices/iopin.sym} 840 -280 2 0 {name=p4 lab=Cap2}
C {devices/iopin.sym} 920 -380 0 0 {name=p5 lab=Cap3}
C {devices/iopin.sym} 940 -340 1 0 {name=p6 lab=Cap4}
...
C {devices/iopin.sym} 1300 -400 0 0 {name=p7 lab=Vtri}
C {madvlsi/resistor.sym} 900 -330 2 0 {name=R5
value=0
m=1}
...
spiceprefix=X
mult=1}
C {sky130_fd_pr/res_xhigh_po_0p35.sym} 730 -220 3 0 {name=R2
W=0.35
L=175
model=res_xhigh_po_0p35
spiceprefix=X
