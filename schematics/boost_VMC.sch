...
N 160 -260 190 -260 { lab=#net1}
N 200 -260 240 -260 { lab=vdrain}
N 360 -260 370 -260 { lab=#net2}
N 380 -260 400 -260 { lab=vout}
N 360 -260 370 -260 { lab=#net2}
N 400 -180 400 -160 { lab=#net3}
N 400 -150 400 -80 { lab=GND}
N 530 -180 530 -160 { lab=#net4}
N 530 -150 530 -80 { lab=GND}
N 80 -260 100 -260 { lab=vin}
N 470 -260 470 -240 { lab=vout}
N 480 -260 530 -260 { lab=vout}
N 470 -180 470 -160 { lab=#net5}
N 470 -150 470 -80 { lab=GND}
...
N 840 -460 930 -460 { lab=#net6}
N 880 -480 880 -460 { lab=#net6}
N 880 -560 880 -540 { lab=Vref}
N 660 -170 760 -170 { lab=vfb}
N 760 -420 760 -170 { lab=vfb}
N 760 -420 780 -420 { lab=vfb}
N 840 -420 880 -420 { lab=#net7}
N 880 -420 880 -410 { lab=#net7}
N 880 -410 880 -400 { lab=#net7}
N 880 -420 930 -420 { lab=#net7}
N 880 -340 880 -320 { lab=Vdiff}
N 880 -320 1100 -320 { lab=Vdiff}
N 930 -460 940 -460 { lab=#net6}
N 930 -420 940 -420 { lab=#net7}
N 1100 -440 1100 -320 { lab=Vdiff}
N 1080 -440 1100 -440 { lab=Vdiff}
N 1100 -320 1160 -320 { lab=Vdiff}
N 1140 -280 1160 -280 { lab=#net8}
N 1140 -280 1140 -200 { lab=#net8}
N 1140 -200 1320 -200 { lab=#net8}
N 1320 -300 1320 -200 { lab=#net8}
N 1300 -300 1320 -300 { lab=#net8}
N 1100 -510 1100 -440 { lab=Vdiff}
N 1100 -520 1160 -520 { lab=Vdiff}
N 1140 -480 1160 -480 { lab=#net9}
N 1100 -520 1100 -510 { lab=Vdiff}
N 1140 -480 1140 -420 { lab=#net9}
N 1140 -420 1140 -400 { lab=#net9}
N 1140 -400 1320 -400 { lab=#net9}
N 1320 -500 1320 -400 { lab=#net9}
N 1300 -500 1320 -500 { lab=#net9}
N 1320 -300 1360 -300 { lab=#net8}
N 1420 -300 1460 -300 { lab=Vp}
N 1460 -300 1460 -280 { lab=Vp}
N 1460 -220 1460 -200 { lab=GND}
N 1320 -500 1340 -500 { lab=#net9}
N 1400 -500 1440 -500 { lab=#net10}
N 1420 -500 1420 -420 { lab=#net10}
N 1420 -420 1480 -420 { lab=#net10}
N 1470 -360 1480 -360 { lab=#net10}
N 1460 -360 1470 -360 { lab=#net10}
N 1460 -420 1460 -360 { lab=#net10}
...
N 1320 -540 1340 -540 { lab=Vref}
N 1400 -540 1440 -540 { lab=#net11}
N 1700 -520 1720 -520 { lab=#net12}
N 1780 -520 1790 -520 { lab=#net13}
N 1790 -520 1800 -520 { lab=#net13}
N 1790 -520 1790 -450 { lab=#net13}
N 1790 -450 1840 -450 { lab=#net13}
N 1900 -450 1980 -450 { lab=Vi}
N 1980 -540 1980 -450 { lab=Vi}
N 1940 -540 1980 -540 { lab=Vi}
N 1980 -540 2000 -540 { lab=Vi}
N 1670 -560 1700 -560 { lab=Vref}
N 1760 -560 1800 -560 { lab=#net14}
N 1620 -520 1640 -520 { lab=Vint}
N 1780 -320 1820 -320 { lab=#net15}
N 1780 -280 1800 -280 { lab=#net15}
N 1800 -320 1800 -280 { lab=#net15}
N 1820 -320 1840 -320 { lab=#net15}
N 1460 -300 1540 -300 { lab=Vp}
N 1520 -260 1540 -260 { lab=#net16}
N 1520 -260 1520 -180 { lab=#net16}
N 1520 -180 1700 -180 { lab=#net16}
N 1700 -280 1700 -180 { lab=#net16}
N 1680 -280 1700 -280 { lab=#net16}
N 2000 -500 2020 -500 { lab=#net17}
N 2000 -500 2000 -420 { lab=#net17}
N 2000 -420 2180 -420 { lab=#net17}
N 2180 -520 2180 -420 { lab=#net17}
N 2160 -520 2180 -520 { lab=#net17}
N 2000 -540 2020 -540 { lab=Vi}
N 1700 -280 1720 -280 { lab=#net16}
N 1720 -400 1720 -320 { lab=#net17}
N 1720 -400 2000 -400 { lab=#net17}
N 2000 -420 2000 -400 { lab=#net17}
N 1820 -280 1840 -280 { lab=#net18}
N 1820 -280 1820 -260 { lab=#net18}
N 1820 -200 1820 -180 { lab=#net19}
N 1820 -180 1840 -180 { lab=#net19}
N 1900 -180 1920 -180 { lab=Vref}
N 1980 -300 2140 -300 { lab=VPI}
N 2120 -260 2140 -260 { lab=Vsaw}
N 2280 -280 2300 -280 { lab=Vgate}
N 250 -740 250 -730 { lab=Vref}
N 250 -720 250 -700 { lab=#net20}
N 240 -210 240 -200 { lab=vdrain}
N -610 -290 -590 -290 { lab=Vgate}
N 240 -140 240 -110 { lab=#net21}
N 2300 -280 2300 -260 { lab=Vgate}
N 200 -170 210 -170 { lab=Vgate2}
N 110 -170 200 -170 { lab=Vgate2}
...
N 80 -170 110 -170 { lab=Vgate2}
N -280 -190 -220 -190 { lab=#net22}
N -240 -150 -220 -150 { lab=Vgate2}
N -240 -150 -240 -60 { lab=Vgate2}
N -240 -60 -60 -60 { lab=Vgate2}
N -60 -170 -60 -60 { lab=Vgate2}
N -80 -170 -60 -170 { lab=Vgate2}
N -60 -170 80 -170 { lab=Vgate2}
N -800 -100 -590 -100 { lab=#net23}
...
C {madvlsi/ammeter1.sym} 190 -260 3 0 {name=VlI}
...
C {madvlsi/ammeter1.sym} 370 -260 3 0 {name=VdiodeI}
C {madvlsi/ammeter1.sym} 400 -160 0 0 {name=VC1I}
...
C {madvlsi/ammeter1.sym} 470 -160 0 0 {name=VC2I}
...
C {devices/lab_pin.sym} 250 -740 2 0 {name=l19 sig_type=std_logic lab=Vref}
...
value=100k
m=1}
C {madvlsi/gnd.sym} 1460 -200 0 0 {name=l27 lab=GND}
...
value=1000k
m=1}
C {devices/lab_pin.sym} 1320 -540 0 0 {name=l33 sig_type=std_logic lab=Vref}
C {madvlsi/resistor.sym} 1370 -540 3 0 {name=R12
value=10
m=1}
C {/home/madvlsi/Documents/MADVLSI_final/schematics/opamp.sym} 1920 -540 0 0 {name=X7}
C {devices/lab_pin.sym} 1670 -560 0 0 {name=l34 sig_type=std_logic lab=Vref}
...
C {madvlsi/resistor.sym} 1730 -560 3 0 {name=R15
value=10
m=1}
...
C {madvlsi/resistor.sym} 1820 -230 2 0 {name=R18
value=100k
m=1}
C {madvlsi/resistor.sym} 1870 -180 3 0 {name=R19
value=100k
m=1}
C {devices/lab_pin.sym} 1920 -180 2 0 {name=l45 sig_type=std_logic lab=Vref}
...
value="pulse(0 1.8 100us 9.99us 10ns 0 10us)"}
...
C {madvlsi/resistor.sym} 2300 -230 0 0 {name=R20
value=100k
m=1}
C {madvlsi/gnd.sym} 2300 -200 0 0 {name=l59 lab=GND}
...
C {devices/lab_pin.sym} 80 -170 1 0 {name=l66 sig_type=std_logic lab=Vgate2}
