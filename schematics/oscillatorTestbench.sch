...
N 680 -200 710 -200 { lab=Vclk}
C {madvlsi/vsource.sym} 650 -330 0 0 {name=Vdd
value=1.8}
C {madvlsi/gnd.sym} 650 -300 0 0 {name=l1 lab=GND}
...
C {madvlsi/vdd.sym} 650 -360 0 0 {name=l6 lab=VDD}
...
C {devices/lab_pin.sym} 710 -200 2 0 {name=l4 sig_type=std_logic lab=Vclk}
